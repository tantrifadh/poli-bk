                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $queryDataPasien = "SELECT pasien.nama, daftar_poli.keluhan, daftar_poli.status_periksa, daftar_poli.id, 
                                    daftar_poli.no_antrian FROM daftar_poli INNER JOIN pasien ON daftar_poli.id_pasien = pasien.id INNER JOIN 
                                    ...
                                    $resultDataPasien = mysqli_query($mysqli,$queryDataPasien);

                                    while ($data = mysqli_fetch_assoc($resultDataPasien)) {
                                        # code...
                                ?>
                                <tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <?php
                                                            $idPendaftaranPoli = $data['id'];
                                                            require 'config/koneksi.php';
                                                            $ambilDataPeriksa = mysqli_query($mysqli,"SELECT * FROM periksa INNER JOIN daftar_poli ON 
                                                            periksa.id_daftar_poli = daftar_poli.id WHERE daftar_poli.id = '$idPendaftaranPoli'");
